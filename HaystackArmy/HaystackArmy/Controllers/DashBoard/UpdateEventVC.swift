...
extension UpdateEventVC{
    func UpdateEventInfoMethod(lat:String,Long:String){
        ...
        NetworkManager2.Apicalling(url: API_URl.UpdateEvent_URL, paramaters: parameters, ImageData: imageData, httpMethodType: .post, success: { (response:UserModel) in
